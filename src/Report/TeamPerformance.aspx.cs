...
namespace CRM.Report
{
    public partial class TeamPerformance : System.Web.UI.Page
    {
        ...
        private DataSet Getdata(string querydate)
        {
            ...
            string strSQL = @"select  '第'+ cast(row_number()over(order by num ) as varchar(10))+'名' as '名次',team as '团队名称' from (
select  b.team,COUNT(*) as num  from   customer a,Employee b
where  " + query + @" and a.Owner=b.Name group by   b.team ) c ";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=团队业绩排行榜_" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xls");
