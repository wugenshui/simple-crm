...
{
    public partial class Zanbulianxi : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GridViewyiwancheng.DataKeyNames = new string[] { "id", "customername", "phone", "QQ",  "mail", "companyowner",  "contactdate"  };
            GridViewyiwancheng.DataBind();
        }
        private DataSet Getdata(string teamName)
        {

            string strSQL = @"select  * from   CustomerNoContact
                  where  status='new' ";
