...
<head>
    ...
    <style type="text/css">
        ...
        .GridViewHeaderStyle,.GridViewRowStyle {
                                ...
                                <div class="widget-content tab-content">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="手机">
                                                    <ItemTemplate><%# Eval("customerphone")%> </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="QQ">
                                                    <ItemTemplate><%# Eval("customerqq")%> </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="邮箱">
                                                    <ItemTemplate><%# Eval("mail") %> </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="客户类型">
                                                    <ItemTemplate><%# Eval("customertype")%> </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="状态">
                                                    <ItemTemplate><%# Eval("status") %> </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="合同附件">
                                                    <ItemTemplate><%# Eval("contract") %> </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div id="tab2" runat="server" class="tab-pane">
                                        ...
                                        <div class="modal hide" id="modal-add-event">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A1">备注</a>
                                                    <input id="eventname" type="text" runat="server" />
                                                </p>
                                                <p>对客户跟进操作</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="xiugai222" runat="server" OnClick="Buttongenjin2_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-zuofei2">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button2" runat="server" OnClick="Buttonzuifei2_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-queren2">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button3" runat="server" OnClick="Buttonqueren2_Click" Text="确认" />
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab3" runat="server" class="tab-pane">
                                        ...
                                        <div class="modal hide" id="zanbulianxidiv">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    联系时间:<div id="rili" data-date="12-02-2012" class="input-append date datepicker">
                                                ...
                                                <p>
                                                    <a id="A14">备注</a>
                                                    <input id="zanbulianxiyfpremark" type="text" runat="server" />
                                                </p>
                                                <p>对客户暂不联系操作</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button17" runat="server" OnClick="Buttonzanbulianxiyfp_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-yiqueren">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button5" runat="server" OnClick="Buttonyiquerengenjin_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-fenpei">
                                            ...
                                            <div class="modal-footer">
                                                <a id="fenpeikefu">分配客服</a>
                                                <select data-toggle="select" style="width: 220px; z-index: 99999;" runat="server" id="fenpeikefuselect">
                                                </select>
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button6" runat="server" OnClientClick="getselect()" OnClick="Buttonyiquerenfenpei_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="Div3">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button7" runat="server" OnClick="Buttonqueren2_Click" Text="确认" />
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab4" runat="server" class="tab-pane">
                                        ...
                                        <div class="modal hide" id="modal-yifenpei">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button9" runat="server" OnClick="Buttonyifenpeigenjin_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-fenpeihuifang">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A2">备注</a>
                                                    <input id="yifenpeihuifangremark" type="text" runat="server" />
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button10" runat="server" OnClick="Buttonyifenpeihuifang_Click" Text="确认" />
                                            </div>
                                        </div>
                                    ...
                                    <div id="tab5" runat="server" class="tab-pane">
                                        ...
                                        <div class="modal hide" id="modal-yilianxigenjin">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A12">备注</a>
                                                    <input id="yilianxigenjinremark" type="text" runat="server" />
                                                </p>
                                                <p>对客户跟进操作</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button12" runat="server" OnClick="Buttonyilianxigenjin_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-yilianxihuifang">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A24">备注</a>
                                                    <input id="yilianxihuifangremark" type="text" runat="server" />
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button13" runat="server" OnClick="Buttonyilianxihuifang_Click" Text="确认" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab6" runat="server" class="tab-pane">
                                        ...
                                        <div class="modal hide" id="modal-yiwanchenggenjin">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A13">备注</a>
                                                    <input id="yiwanchenggenjinremark" type="text" runat="server" />
                                                </p>
                                                <p>对客户跟进操作</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button15" runat="server" OnClick="Buttonyiwanchenggenjin_Click" Text="确认" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal hide" id="modal-yiwanchenghuifang">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>
                                                    <a id="A26">备注</a>
                                                    <input id="yiwanchenghuifangremark" type="text" runat="server" />
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="close" data-dismiss="modal">取消</button><asp:Button ID="Button16" runat="server" OnClick="Buttonyiwanchenghuifang_Click" Text="确认" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
