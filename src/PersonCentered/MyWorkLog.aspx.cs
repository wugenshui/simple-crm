...
{
    public partial class MyWorkLog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GridView1.DataKeyNames = new string[] { "id", "Subject", "createdate" };
            GridView1.DataBind();
        ...
        private DataSet Getdata()
        {
            ...
            string strSQL = "select id, Subject,createdate from mylog where emp='" + Session["user"].ToString() + "'  order by createdate  desc    ";
            DataSet ds = new DataSet();
        ...
        protected void btnOpenClick(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "delete1")
            {
                ...
                logic.DeleteRizhi(OrderID, Connection);
                DataSet ds = new DataSet();
            ...
            else if (e.CommandName == "chakan1")
            {
                ...
                Response.Redirect("QueryRizhi.aspx?mid=" + OrderID);
