...
{
    public partial class Yejizoushitu : System.Web.UI.Page
    {
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public string Getdata(string selectitem)
        {
        ...
        public DataSet GetdataDetail()
        {
            ...
            string strSQL = @" select a.times,sum(a.tianjia) tianjia,sum(a.feipei) feipei,sum(a.lianxi) lianxi,
