<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRiZhi.aspx.cs" validateRequest="false" Inherits="CRM.PersonCentered.AddRiZhi" %>
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,800' rel='stylesheet' type='text/css'/>
  <script type="text/javascript">
      ...
      function getSubject() {
          ...
          var value_1 = document.getElementById("subject");
          value_1.value = CurentTime() + "工作日志";
   ...
   <div class="widget-box">
        ...
        <div class="row-fluid">
          ...
          <div class="widget-content">   
              ...
              <div class="controls">
                <input style="width:220px;"  runat="server"  id="subject"   type="text" class="span"  />
                  <textarea class="textarea_editor span12" rows="6" id="contents"  runat="server"   placeholder="输入日志内容"></textarea>
