<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyPerformance.aspx.cs" Inherits="CRM.Report.CompanyPerformance" %>
...
<div id="content-header">
  <div id="breadcrumb"  > <a href="index.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="tip-bottom">统计报表</a> <a href="#" class="current">公司业绩排行榜</a> </div>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="公司名称"><ItemTemplate> <%# Eval("公司名称")%> </ItemTemplate></asp:TemplateField>
