<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamPerformance.aspx.cs" Inherits="CRM.Report.TeamPerformance" %>
...
<div id="content-header">
  <div id="breadcrumb" > <a href="index.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="tip-bottom">统计报表</a> <a href="#" class="current">团队业绩排行榜</a> </div>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="团队名称"><ItemTemplate> <%# Eval("团队名称")%> </ItemTemplate></asp:TemplateField>
