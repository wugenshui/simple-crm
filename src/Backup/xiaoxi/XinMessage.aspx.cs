...
{
    public partial class XinMessage : System.Web.UI.Page
    {
        ...
        private DataSet Getdata()
        {
            ...
            string strSQL = "select OrderID,Sender,Receiver,Subject,Mcontent,Send_date,Mstatus from message where Receiver='" + Session["user"].ToString() + "' and Mstatus='未读' order by Send_date  desc    ";
            DataSet ds = new DataSet();
