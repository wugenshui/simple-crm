<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMessage.aspx.cs" Inherits="CRM.xiaoxi.NewMessage" %>
...
<div id="content-header">
  <div id="breadcrumb"  > <a href="../ifrmMain.aspx" title="返回首页" class="tip-bottom"><i class="icon-home"></i>消息</a> <a href="#" class="tip-bottom">新消息</a></div>
  <h1>发送新消息</h1>
</div>
        ...
        <div class="widget-content nopadding">
          <form id="Form1" action="#" method="post" class="form-horizontal" runat="server" Autocomplete ="On">
            ...
            <div id="Div1" class="form-actions" runat="server">
                           <asp:button ID="Button1" class="btn btn-primary" type="submit" runat="server" Text="发送" 
