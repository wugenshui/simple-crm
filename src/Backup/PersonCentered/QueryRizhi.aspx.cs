...
{
    public partial class QueryRizhi : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //rizhicontent.Value = ds.Tables[0].Rows[0]["contents"].ToString();
            testa.InnerHtml = ds.Tables[0].Rows[0]["contents"].ToString();
            subject.Attributes.Add("readonly", "readonly");
           // rizhicontent.Attributes.Add("readonly", "readonly");

        }
        public DataSet Getdata(string messageid)
        {

            string strSQL = "select * from mylog where id= '" + messageid + "'    ";
            DataSet ds = new DataSet();
