<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fajianxiang.aspx.cs" Inherits="CRM.xiaoxi.Fajianxiang" %>
...
<div id="content-header">
  <div id="breadcrumb" > <a href="index.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="tip-bottom">消息</a> <a href="#" class="current">发件箱</a> </div>
</div>
