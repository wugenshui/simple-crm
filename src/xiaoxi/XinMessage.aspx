<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XinMessage.aspx.cs" Inherits="CRM.xiaoxi.XinMessage" %>
...
<div id="content-header">
  <div id="breadcrumb"  > <a href="index.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="tip-bottom">消息</a> <a href="#" class="current">新消息</a> </div>
</div>
