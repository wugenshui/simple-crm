...
namespace CRM.xiaoxi
{
    public partial class Fajianxiang : System.Web.UI.Page
    {
        ...
        private DataSet Getdata()
        {
            ...
            string strSQL = "select OrderID,Sender,Receiver,Subject,Mcontent,Send_date,Mstatus from message where Sender='" + Session["user"].ToString() + "' order by Send_date  desc    ";
            DataSet ds = new DataSet();
